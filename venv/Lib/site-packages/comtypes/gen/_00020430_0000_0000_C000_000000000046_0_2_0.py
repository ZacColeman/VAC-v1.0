...
IFontDisp = Font
__all__ = [ 'Gray', 'OLE_TRISTATE', 'IFontDisp', 'FontEvents',
           'FONTUNDERSCORE', 'OLE_COLOR', 'Color', 'OLE_YSIZE_PIXELS',
           'OLE_CANCELBOOL', 'IFont', 'OLE_ENABLEDEFAULTBOOL',
           'Monochrome', 'IPicture', 'FONTITALIC',
           'OLE_YPOS_CONTAINER', 'Unchecked', 'OLE_XSIZE_PIXELS',
           'OLE_XPOS_CONTAINER', 'LoadPictureConstants',
           'OLE_OPTEXCLUSIVE', 'VgaColor', 'FONTNAME', 'Font',
           'FONTBOLD', 'OLE_YSIZE_HIMETRIC', 'FONTSIZE',
           'OLE_YPOS_PIXELS', 'OLE_XPOS_PIXELS', 'OLE_XSIZE_HIMETRIC',
           'OLE_YSIZE_CONTAINER', 'OLE_HANDLE', 'IPictureDisp',
           'OLE_XSIZE_CONTAINER', 'StdPicture', 'Checked', 'Default',
